...
export class PaymentService {
  ...
  getMember(id: number): Observable<Member> {
    ...
    return this.http.get<Member>(url).
      pipe(tap(_ = > console.log(`fetched member id = ${id}`)),
    ...
    payment.paymentMessage = "Your payment of $" + payment.paymentAmount + " has been processed!"; return of(payment);
  }

  /** * Handle Http operation that failed. * 
  Let the app continue. * @param operation - name of the operation that failed 
